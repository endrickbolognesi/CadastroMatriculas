...
<script type="text/javascript">
  ...
  var dateEditor = function(cell, onRendered, success, cancel){
      ...
      columns:[
          ...
          {title:"Nome", field:"name", width:100},
          {title:"Data Certa F", field:"dataCerta", formatter:"datetime", formatterParams:{
              inputFormat:"YYYY-MM-DD",
              outputFormat:"DD/MM/YYYY",
              invalidPlaceholder:"(Data inválida)",
          }},
          {title:"Atos Cadastrados", field:"atosCad"},
          {title:"Atos Existentes", field:"atosExis"},
          {title:"Dúvidas", field:"duvidas"},
      ],
